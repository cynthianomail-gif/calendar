...
# 各國主要機場（IATA 代碼 + 中文名），供查機票的選單使用。
# 每個國家的第一筆視為預設門戶。有城市代碼的（TYO、LON、PAR…）放第一筆，
# 因為查價時「該城市所有機場」通常是使用者要的。
AIRPORTS = {
    # ---------------------------------------------------------------- 東亞
    "CN": [("PEK", "北京首都"), ("PKX", "北京大興"), ("PVG", "上海浦東"),
           ("SHA", "上海虹橋"), ("CAN", "廣州"), ("SZX", "深圳"), ("CTU", "成都天府"),
           ("CKG", "重慶"), ("XIY", "西安"), ("HGH", "杭州"), ("NKG", "南京"),
           ("KMG", "昆明"), ("XMN", "廈門"), ("TAO", "青島"), ("HRB", "哈爾濱"),
           ("SYX", "三亞")],
    "JP": [("TYO", "東京（全）"), ("NRT", "東京成田"), ("HND", "東京羽田"),
           ("KIX", "大阪關西"), ("ITM", "大阪伊丹"), ("NGO", "名古屋中部"),
           ("CTS", "札幌新千歲"), ("FUK", "福岡"), ("OKA", "沖繩那霸"),
           ("SDJ", "仙台"), ("HIJ", "廣島"), ("KMJ", "熊本"), ("KOJ", "鹿兒島"),
           ("TAK", "高松"), ("KMQ", "小松"), ("AOJ", "青森"), ("HKD", "函館"),
           ("ISG", "石垣")],
    "KR": [("SEL", "首爾（全）"), ("ICN", "首爾仁川"), ("GMP", "首爾金浦"),
           ("PUS", "釜山"), ("CJU", "濟州"), ("TAE", "大邱"), ("KWJ", "光州")],
    "TW": [("TPE", "台北桃園"), ("TSA", "台北松山"), ("KHH", "高雄"), ("RMQ", "台中"),
           ("TNN", "台南"), ("HUN", "花蓮"), ("MZG", "澎湖"), ("KNH", "金門")],
    "HK": [("HKG", "香港")],
    "MO": [("MFM", "澳門")],
    "MN": [("ULN", "烏蘭巴托")],
    ...
    # -------------------------------------------------------------- 東南亞
    "SG": [("SIN", "新加坡樟宜")],
    "MY": [("KUL", "吉隆坡"), ("PEN", "檳城"), ("BKI", "亞庇"), ("LGK", "蘭卡威"),
           ("JHB", "新山"), ("KCH", "古晉")],
    "TH": [("BKK", "曼谷素萬那普"), ("DMK", "曼谷廊曼"), ("CNX", "清邁"),
           ("HKT", "普吉"), ("USM", "蘇梅島"), ("KBV", "喀比"), ("HDY", "合艾"),
           ("UTP", "芭達雅烏塔堡")],
    "VN": [("SGN", "胡志明市"), ("HAN", "河內"), ("DAD", "峴港"), ("CXR", "芽莊"),
           ("PQC", "富國島"), ("HPH", "海防"), ("HUI", "順化")],
    "ID": [("CGK", "雅加達"), ("DPS", "峇里島"), ("SUB", "泗水"), ("JOG", "日惹"),
           ("LOP", "龍目島"), ("MDC", "美娜多"), ("UPG", "望加錫")],
    "PH": [("MNL", "馬尼拉"), ("CEB", "宿霧"), ("CRK", "克拉克"), ("DVO", "達沃"),
           ("KLO", "卡利博（長灘島）"), ("PPS", "公主港")],
    "KH": [("PNH", "金邊"), ("REP", "暹粒"), ("KOS", "施亞努港")],
    "LA": [("VTE", "永珍"), ("LPQ", "龍坡邦")],
    "MM": [("RGN", "仰光"), ("MDL", "曼德勒"), ("NYU", "娘瓦")],
    "BN": [("BWN", "斯里巴加灣")],

    # ---------------------------------------------------------------- 南亞
    "IN": [("DEL", "德里"), ("BOM", "孟買"), ("BLR", "班加羅爾"), ("MAA", "清奈"),
           ("HYD", "海得拉巴"), ("CCU", "加爾各答"), ("COK", "科欽"), ("GOI", "果亞"),
           ("AMD", "艾哈邁達巴德"), ("JAI", "齋浦爾")],
    "NP": [("KTM", "加德滿都"), ("PKR", "波卡拉")],
    "LK": [("CMB", "可倫坡")],
    "MV": [("MLE", "馬列")],
    "BD": [("DAC", "達卡"), ("CGP", "吉大港")],
    "PK": [("ISB", "伊斯蘭馬巴德"), ("KHI", "喀拉蚩"), ("LHE", "拉合爾")],

    # ---------------------------------------------------------- 中亞高加索
    "KZ": [("ALA", "阿拉木圖"), ("NQZ", "阿斯塔納")],
    "UZ": [("TAS", "塔什干"), ("SKD", "撒馬爾罕")],
    "GE": [("TBS", "提比里西"), ("BUS", "巴統"), ("KUT", "庫塔伊西")],
    "AM": [("EVN", "葉里溫")],
    "AZ": [("GYD", "巴庫")],

    # ---------------------------------------------------------------- 中東
    "TR": [("IST", "伊斯坦堡"), ("SAW", "伊斯坦堡薩比哈"), ("AYT", "安塔利亞"),
           ("ESB", "安卡拉"), ("ADB", "伊茲密爾"), ("ASR", "開塞利（卡帕多奇亞）"),
           ("NAV", "內夫謝希爾"), ("DLM", "達拉曼"), ("BJV", "博德魯姆")],
    "IL": [("TLV", "特拉維夫"), ("ETH", "埃拉特")],
    "AE": [("DXB", "杜拜"), ("AUH", "阿布達比"), ("SHJ", "沙迦")],
    "SA": [("RUH", "利雅德"), ("JED", "吉達"), ("DMM", "達曼"), ("MED", "麥地那")],
    "QA": [("DOH", "杜哈")],
    "KW": [("KWI", "科威特")],
    "BH": [("BAH", "巴林")],
    "OM": [("MCT", "馬斯喀特"), ("SLL", "塞拉萊")],
    "JO": [("AMM", "安曼"), ("AQJ", "阿卡巴")],
    "LB": [("BEY", "貝魯特")],
    "IR": [("IKA", "德黑蘭"), ("SYZ", "設拉子"), ("IFN", "伊斯法罕")],
    "IQ": [("BGW", "巴格達"), ("EBL", "艾比爾")],

    # ---------------------------------------------------------------- 歐洲
    "GB": [("LON", "倫敦（全）"), ("LHR", "倫敦希斯洛"), ("LGW", "倫敦蓋威克"),
           ("STN", "倫敦史坦斯特"), ("LTN", "倫敦盧頓"), ("MAN", "曼徹斯特"),
           ("EDI", "愛丁堡"), ("GLA", "格拉斯哥"), ("BHX", "伯明罕"),
           ("BRS", "布里斯托"), ("NCL", "新堡"), ("BFS", "貝爾法斯特")],
    "IE": [("DUB", "都柏林"), ("ORK", "科克"), ("SNN", "香農")],
    "FR": [("PAR", "巴黎（全）"), ("CDG", "巴黎戴高樂"), ("ORY", "巴黎奧利"),
           ("NCE", "尼斯"), ("LYS", "里昂"), ("MRS", "馬賽"), ("TLS", "土魯斯"),
           ("BOD", "波爾多"), ("NTE", "南特"), ("SXB", "史特拉斯堡")],
    "DE": [("FRA", "法蘭克福"), ("MUC", "慕尼黑"), ("BER", "柏林"),
           ("DUS", "杜塞道夫"), ("HAM", "漢堡"), ("CGN", "科隆"),
           ("STR", "斯圖加特"), ("HAJ", "漢諾威"), ("NUE", "紐倫堡")],
    "NL": [("AMS", "阿姆斯特丹"), ("EIN", "恩荷芬"), ("RTM", "鹿特丹")],
    "BE": [("BRU", "布魯塞爾"), ("CRL", "沙勒羅瓦"), ("ANR", "安特衛普")],
    "LU": [("LUX", "盧森堡")],
    "CH": [("ZRH", "蘇黎世"), ("GVA", "日內瓦"), ("BSL", "巴塞爾"), ("BRN", "伯恩")],
    "AT": [("VIE", "維也納"), ("SZG", "薩爾斯堡"), ("INN", "因斯布魯克")],
    "IT": [("ROM", "羅馬（全）"), ("FCO", "羅馬菲烏米奇諾"), ("CIA", "羅馬錢皮諾"),
           ("MIL", "米蘭（全）"), ("MXP", "米蘭馬爾彭薩"), ("LIN", "米蘭利納特"),
           ("BGY", "米蘭貝加莫"), ("VCE", "威尼斯"), ("FLR", "佛羅倫斯"),
           ("NAP", "拿坡里"), ("BLQ", "波隆那"), ("PSA", "比薩"),
           ("CTA", "卡塔尼亞"), ("PMO", "巴勒摩"), ("TRN", "杜林"), ("BRI", "巴里")],
    "ES": [("MAD", "馬德里"), ("BCN", "巴塞隆納"), ("AGP", "馬拉加"),
           ("PMI", "帕爾馬"), ("VLC", "瓦倫西亞"), ("SVQ", "塞維亞"),
           ("ALC", "阿利坎特"), ("BIO", "畢爾包"), ("TFS", "特內里費"),
           ("LPA", "大加那利")],
    "PT": [("LIS", "里斯本"), ("OPO", "波爾圖"), ("FAO", "法魯"), ("FNC", "馬德拉")],
    "GR": [("ATH", "雅典"), ("SKG", "塞薩洛尼基"), ("JTR", "聖托里尼"),
           ("JMK", "米科諾斯"), ("HER", "克里特伊拉克利翁"), ("RHO", "羅德島"),
           ("CFU", "科孚島")],
    "MT": [("MLA", "馬爾他")],
    "CY": [("LCA", "拉納卡"), ("PFO", "帕福斯")],
    "DK": [("CPH", "哥本哈根"), ("BLL", "比隆"), ("AAL", "奧爾堡")],
    "SE": [("STO", "斯德哥爾摩（全）"), ("ARN", "斯德哥爾摩阿蘭達"),
           ("GOT", "哥特堡"), ("MMX", "馬爾默")],
    "NO": [("OSL", "奧斯陸"), ("BGO", "卑爾根"), ("TRD", "特隆赫姆"),
           ("TOS", "特羅姆瑟"), ("SVG", "斯塔萬格")],
    "FI": [("HEL", "赫爾辛基"), ("RVN", "羅瓦涅米"), ("OUL", "奧盧")],
    "IS": [("KEF", "雷克雅維克凱夫拉維克"), ("AEY", "阿克雷里")],
    "EE": [("TLL", "塔林")],
    "LV": [("RIX", "里加")],
    "LT": [("VNO", "維爾紐斯"), ("KUN", "考納斯")],
    "PL": [("WAW", "華沙"), ("KRK", "克拉科夫"), ("GDN", "格但斯克"),
           ("WRO", "弗羅茨瓦夫"), ("POZ", "波茲南"), ("KTW", "卡托維治")],
    "CZ": [("PRG", "布拉格"), ("BRQ", "布爾諾")],
    "SK": [("BTS", "布拉提斯拉瓦"), ("KSC", "科希策")],
    "HU": [("BUD", "布達佩斯")],
    "SI": [("LJU", "盧比安納")],
    "HR": [("ZAG", "札格瑞布"), ("SPU", "斯普利特"), ("DBV", "杜布羅夫尼克"),
           ("ZAD", "札達爾"), ("PUY", "普拉")],
    "BA": [("SJJ", "塞拉耶佛"), ("OMO", "莫斯塔爾")],
    "RS": [("BEG", "貝爾格勒"), ("INI", "尼什")],
    "ME": [("TGD", "波德里察"), ("TIV", "蒂瓦特")],
    "MK": [("SKP", "史高比耶"), ("OHD", "奧赫里德")],
    "AL": [("TIA", "地拉那")],
    "RO": [("OTP", "布加勒斯特"), ("CLJ", "克盧日"), ("TSR", "蒂米什瓦拉")],
    "BG": [("SOF", "索菲亞"), ("VAR", "瓦爾納"), ("BOJ", "布爾加斯")],
    "UA": [("KBP", "基輔"), ("LWO", "利維夫"), ("ODS", "敖德薩")],
    "RU": [("MOW", "莫斯科（全）"), ("SVO", "莫斯科謝列梅捷沃"),
           ("DME", "莫斯科多莫傑多沃"), ("VKO", "莫斯科伏努科沃"),
           ("LED", "聖彼得堡"), ("VVO", "海參崴"), ("KZN", "喀山"), ("AER", "索契")],
    "BY": [("MSQ", "明斯克")],
    "MD": [("KIV", "基希涅夫")],

    # ---------------------------------------------------------------- 美洲
    "US": [("NYC", "紐約（全）"), ("JFK", "紐約甘迺迪"), ("EWR", "紐華克"),
           ("LGA", "紐約拉瓜地亞"), ("LAX", "洛杉磯"), ("SFO", "舊金山"),
           ("SEA", "西雅圖"), ("ORD", "芝加哥"), ("BOS", "波士頓"),
           ("WAS", "華盛頓（全）"), ("IAD", "華盛頓杜勒斯"), ("MIA", "邁阿密"),
           ("MCO", "奧蘭多"), ("LAS", "拉斯維加斯"), ("DFW", "達拉斯"),
           ("IAH", "休士頓"), ("ATL", "亞特蘭大"), ("DEN", "丹佛"),
           ("PHX", "鳳凰城"), ("SAN", "聖地牙哥"), ("HNL", "檀香山"),
           ("OGG", "茂宜島"), ("ANC", "安克拉治"), ("GUM", "關島"), ("SJU", "聖胡安")],
    "CA": [("YTO", "多倫多（全）"), ("YYZ", "多倫多皮爾遜"), ("YVR", "溫哥華"),
           ("YUL", "蒙特婁"), ("YYC", "卡加利"), ("YOW", "渥太華"),
           ("YEG", "埃德蒙頓"), ("YHZ", "哈利法克斯")],
    "MX": [("MEX", "墨西哥城"), ("CUN", "坎昆"), ("GDL", "瓜達拉哈拉"),
           ("MTY", "蒙特雷"), ("SJD", "洛斯卡沃斯"), ("PVR", "巴亞爾塔港")],
    "GT": [("GUA", "瓜地馬拉市"), ("FRS", "佛羅雷斯")],
    "CR": [("SJO", "聖荷西"), ("LIR", "利比里亞")],
    "PA": [("PTY", "巴拿馬城")],
    "CU": [("HAV", "哈瓦那"), ("VRA", "巴拉德羅")],
    "DO": [("SDQ", "聖多明哥"), ("PUJ", "蓬塔卡納")],
    "JM": [("KIN", "金斯敦"), ("MBJ", "蒙特哥灣")],
    "CO": [("BOG", "波哥大"), ("MDE", "麥德林"), ("CTG", "卡塔赫納"), ("CLO", "卡利")],
    "VE": [("CCS", "卡拉卡斯")],
    "EC": [("UIO", "基多"), ("GYE", "瓜亞基爾"), ("GPS", "加拉巴哥")],
    "PE": [("LIM", "利馬"), ("CUZ", "庫斯科"), ("AQP", "阿雷基帕")],
    "BO": [("LPB", "拉巴斯"), ("VVI", "聖克魯斯")],
    "CL": [("SCL", "聖地牙哥"), ("IPC", "復活節島"), ("PMC", "蒙特港"), ("CJC", "卡拉馬")],
    "AR": [("BUE", "布宜諾斯艾利斯（全）"), ("EZE", "布宜諾斯艾利斯埃塞薩"),
           ("AEP", "布宜諾斯艾利斯紐貝里"), ("COR", "科爾多瓦"), ("MDZ", "門多薩"),
           ("BRC", "巴里洛切"), ("USH", "烏斯懷亞"), ("IGR", "伊瓜蘇")],
    "UY": [("MVD", "蒙特維多"), ("PDP", "埃斯特角城")],
    "PY": [("ASU", "亞松森")],
    "BR": [("SAO", "聖保羅（全）"), ("GRU", "聖保羅瓜魯柳斯"),
           ("CGH", "聖保羅孔戈尼亞斯"), ("RIO", "里約（全）"),
           ("GIG", "里約加利昂"), ("SDU", "里約聖杜蒙"), ("BSB", "巴西利亞"),
           ("SSA", "薩爾瓦多"), ("REC", "累西腓"), ("FOR", "福塔萊薩"),
           ("MAO", "馬瑙斯"), ("IGU", "伊瓜蘇"), ("POA", "阿雷格里港"),
           ("CNF", "貝洛奧里藏特")],

    # ---------------------------------------------------------------- 非洲
    "EG": [("CAI", "開羅"), ("HRG", "赫爾格達"), ("SSH", "沙姆沙伊赫"),
           ("LXR", "路克索"), ("ASW", "亞斯文")],
    "MA": [("CMN", "卡薩布蘭加"), ("RAK", "馬拉喀什"), ("RBA", "拉巴特"),
           ("FEZ", "非斯"), ("TNG", "丹吉爾"), ("AGA", "阿加迪爾")],
    "TN": [("TUN", "突尼斯"), ("DJE", "傑爾巴"), ("MIR", "莫納斯提爾")],
    "DZ": [("ALG", "阿爾及爾"), ("ORN", "奧蘭")],
    "ZA": [("JNB", "約翰尼斯堡"), ("CPT", "開普敦"), ("DUR", "德班")],
    "KE": [("NBO", "奈洛比"), ("MBA", "蒙巴薩")],
    "TZ": [("DAR", "三蘭港"), ("JRO", "吉力馬札羅"), ("ZNZ", "尚吉巴")],
    "ET": [("ADD", "阿迪斯阿貝巴")],
    "NG": [("LOS", "拉哥斯"), ("ABV", "阿布加")],
    "GH": [("ACC", "阿克拉")],
    "SN": [("DSS", "達卡爾")],
    "MU": [("MRU", "模里西斯")],
    "SC": [("SEZ", "塞席爾")],
    "ZW": [("HRE", "哈拉雷"), ("VFA", "維多利亞瀑布")],
    "UG": [("EBB", "恩德培")],
    "NA": [("WDH", "溫荷克")],
    "BW": [("GBE", "嘉伯隆里"), ("MUB", "馬翁")],

    # -------------------------------------------------------------- 大洋洲
    "AU": [("SYD", "雪梨"), ("MEL", "墨爾本"), ("BNE", "布里斯本"), ("PER", "伯斯"),
           ("ADL", "阿德萊德"), ("OOL", "黃金海岸"), ("CNS", "凱恩斯"),
           ("HBA", "荷巴特"), ("DRW", "達爾文"), ("CBR", "坎培拉")],
    "NZ": [("AKL", "奧克蘭"), ("CHC", "基督城"), ("WLG", "威靈頓"), ("ZQN", "皇后鎮")],
    "FJ": [("NAN", "楠迪"), ("SUV", "蘇瓦")],
    "PG": [("POM", "莫爾斯比港")],
    "PW": [("ROR", "科羅")],
}
...
def main():
    ...
    for code, name, en, flag, region, weight, closure in COUNTRIES:
        meta = {"code": code, "name": name, "en": en, "flag": flag,
                ...
                "airports": [{"c": a, "n": n} for a, n in AIRPORTS.get(code, [])],
                "gateway": AIRPORTS[code][0][0] if AIRPORTS.get(code) else ""}
        if code in WEEKENDS:
